...
word_list = [
    ...
    'frazzled',
    'frizzled',
    'fuchsia','funny','gabby','galaxy','galvanize','gazebo','giaour','gizmo','glowworm','glyph','gnarly','gnostic','gossip',
    'grogginess',
    'haiku',
    'haphazard',
    'hyphen',
    ...
    'lucky',
    'luxury',
    'lymph','marquis','matrix','megahertz','microwave','mnemonic','mystify','naphtha','nightclub','nowadays','numbskull','nymph','onyx','ovary','oxidize',
    'oxygen',
    'pajama',
    'peekaboo',
    'phlegm',
...
if guess not in chosen_word:
        lives=lives-1
if lives<6:
    print(f"Wrong choice. Remaining lives: {lives}/6")
    print(stages[lives])
print(display)
for i in display: dis_list.append(i)
